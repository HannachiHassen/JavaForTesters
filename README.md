...
SwapNumbers class [SwapNumbers.java](https://github.com/HannachiHassen/JavaForTesters/blob/master/src/com/numbers/SwapNumbers.java)

### 7. Write a Java program to swap two numbers without using third variable?

SwapNumberWithoutVariable class [SwapNumberWithoutVariable.java](https://github.com/HannachiHassen/JavaForTesters/blob/master/src/com/numbers/SwapNumberWithoutVariable.java)

### 8. Write a Java program to add two numbers?

AddNumbers class [AddNumbers.java](https://github.com/HannachiHassen/JavaForTesters/blob/master/src/com/numbers/AddNumbers.java)
...
### 12. Write a Java program to demonstrate nested if â€¦else statement?
...
FindOddEvenNumbers class [FindOddEvenNumbers.java](https://github.com/HannachiHassen/JavaForTesters/blob/master/src/com/numbers/FindOddEvenNumbers.java)
...
### 27. Write a Java Program to Reverse String?
...
### 28. Write a Java Program to Reverse a String Using toCharArray()?
...
### 29. Write a Java Program to Reverse a string without affecting special characters?

reverse class [reverse.java](https://github.com/HannachiHassen/JavaForTesters/blob/master/src/com/interviewQuestions/reverse.java)

### 30. Write a Java Program to String Word?
